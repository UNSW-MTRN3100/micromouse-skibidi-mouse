    ...
    for (char command : commands) {
        ...
        switch (command) {
            ...
            case 'r':
                ...
                break;
            case 's':
                Serial.println("Set forward distance to 100 mm");
...
void driveStraight(int distance) {
    ...
    controller.zeroAndSetTarget(encoder_odometry.getX(), distance); // Use the passed distance
    ...
    while (fabs(controller.getError()) > 30) {
        ...
        // ACTION: Compute the control signal
